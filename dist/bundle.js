...
window.jQuery = $;
window.$ = $;
var slideshow = __webpack_require__(6);
...
// module
exports.push([module.i, "body {\n  text-align: center; }\n  body .slideshow {\n    position: relative;\n    text-align: left;\n    margin: 0 auto;\n    width: 500px; }\n    body .slideshow .count {\n      color: #929292;\n      font-size: 12px; }\n    body .slideshow .arrows {\n      position: absolute;\n      width: 500px;\n      margin-top: 150px;\n      z-index: 600; }\n      body .slideshow .arrows .arrow {\n        text-align: center;\n        padding-top: 15px;\n        background-color: blue;\n        color: white;\n        width: 50px;\n        height: 50px;\n        border-radius: 50%;\n        cursor: pointer;\n        position: relative;\n        opactiy: 1.0; }\n      body .slideshow .arrows .arrow_left {\n        float: left;\n        left: -25px; }\n      body .slideshow .arrows .arrow_right {\n        float: right;\n        left: 25px; }\n      body .slideshow .arrows .arrow_inactive {\n        opacity: .2;\n        cursor: default; }\n    body .slideshow section {\n      width: 500px;\n      display: none;\n      position: absolute;\n      top: 0;\n      left: 0;\n      z-index: 50; }\n      body .slideshow section div.count {\n        text-align: right; }\n      body .slideshow section img {\n        width: 100%; }\n    body .slideshow section.injected_ad {\n      position: relative;\n      z-index: 550;\n      display: block; }\n      body .slideshow section.injected_ad img {\n        width: 500px;\n        height: 333px; }\n", ""]);
...
var Slideshow = function () {
  ...
  function initializeSlideshow() {
    ...
    if (injectAd && self.options.initialSlide > numSlides) {
      console.log('Sorry, there are only ' + numSlides + ' slides. ' + 'You specified an initialSlide that does not exist. Please set initialSlide to a value between 0 and ' + numSlides + '.');
    }

    if (self.options.injectAdPostSlide > numSlides) {
      console.log('Sorry, the slide you want to place the ad after does not exist. ' + 'Please set injectAdPostSlide to a value between 0 and ' + numSlides + '.');
    }
  ...
  function displayNavigationArrows() {
    $(self.options.containerClass).append('<div class="arrows">' + '<div class="arrow arrow_left">' + '<span class="glyphicon glyphicon-chevron-left"></span>' + '</div>' + '<div class="arrow arrow_right">' + '<span class="glyphicon glyphicon-chevron-right"></span>' + '</div>' + '</div>');
          ...
          if (self.options.jsonDataAvailable) {
            for (var i in data) {
              if (data.hasOwnProperty(i)) {
                $(self.options.containerClass).append('<section class="slide' + i + '">' + '<img src="' + data[i].image + '" />' + '<h4>' + data[i].heading + '</h4>' + '<p>' + data[i].description + '</p>' + '</section>');
              }
            }
          } else {
